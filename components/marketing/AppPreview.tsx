...
export async function AppPreview() {
  ...
  return (
    <section id="download" className="bg-[#f5f0f0] py-16">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 sm:px-6 md:flex-row md:items-center">
        <div className="flex-1">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <button className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-[#8c4a60] px-4 py-3 text-sm font-semibold text-white shadow-md shadow-[#8c4a60]/20 hover:bg-[#7a3f53]">
              {t('cta.ios')}
            </button>
            <button className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg border border-[#74565f] bg-white px-4 py-3 text-sm font-semibold text-[#8c4a60] hover:bg-[#f5f0f0]">
              {t('cta.android')}
            </button>
          </div>
